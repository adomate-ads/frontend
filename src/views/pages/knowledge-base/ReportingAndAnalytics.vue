<template>
  <div id="reporting-and-analytics">
    <FadeIn>
      <div class="bg-dark-purple py-20 px-5">
        <div class="flex flex-col items-center pt-10">
          ...
          <p class="text-white text-center mt-4">
            Learn about how adomate measures your success and how to use the
            data to improve your campaigns
          </p>
        </div>
      ...
      <div class="flex w-5/6 mx-auto my-10 px-5 py-5">
        ...
        <div class="flex-grow px-5 py-5 bg-gray-100">
          ...
          <div class="flex justify-center">
            <img
              src="@/assets/knowledge-base/reportings-analytics/sample-bg.jpg"
              alt="title"
              class="w-1/2"
            />
          </div>
